  ...
  <div>
    ...
    <div class="d-flex w-100 mt-6 flex-column" v-if="educationsSuggestions_education.length > 0">
      ...
      <div class="suggest-card-container">
        <div class="suggest-card-container-scroll">
          <div v-for="(suggestion, index) in educationsSuggestions_education" :key="index" class="suggest-card p-3 mr-3 mb-3">
            {{suggestion.name}}
            <div class="like" v-on:click="addLike(educationsSuggestions_education[index])" >
